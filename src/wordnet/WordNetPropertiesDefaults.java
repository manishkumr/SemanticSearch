 ...
 *
 */
public class WordNetPropertiesDefaults {

      
    /**
     * The location of the configuration file. 
     */
//    public static String CONFIG_PATH = "./wordnet_config/";
//    public static String CONFIG_PATH = "C:/Users/Supannada/Dropbox/PhD/Implementations/ServiceAnnotation/ServiceAnnotationANN_1/wordnet_config/";
    public static String CONFIG_PATH =  "./wordnet_config/";
     ...
     */
    public static String testingType = WordNetPropertiesDefaults.FILE;
    ...
    public static InputStream getInputStream() {
        try {
            if (testingType.equals(WordNetPropertiesDefaults.FILE)) {
                return new FileInputStream(CONFIG_PATH + FILE_CONFIG_NAME);
            } else if (testingType.equals(WordNetPropertiesDefaults.DB)) {
                return new FileInputStream(CONFIG_PATH + DATABASE_CONFIG_NAME);
            } else if (testingType.equals(WordNetPropertiesDefaults.MAP)) {
